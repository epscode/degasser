...
public class EstimateFilamentsConfirmationDialog extends CenterDialogBox {
	...
	public EstimateFilamentsConfirmationDialog(JFrame frame, HeatingProfilePanel heatingProfilePanel) {
	...
	boolean showEstimateFilamentsConfirmationDialog() {
