...
class ControlBoundsDialog extends CenterDialogBox {
	...
	boolean showControlBoundsDialog() {
		...
		fanTemperatureOnOffField.addFocusListener(new FocusAdapter() {
			public void focusGained(FocusEvent e) {

				SwingUtilities.invokeLater(new Runnable() {
					public void run() {
						System.out.println("focus gained");
						System.out.println("before caret position: " + fanTemperatureOnOffField.getCaretPosition());

						int len = fanTemperatureOnOffField.getDocument().getLength();
						System.out.println("FanTemperatureOnOffLength: " + len);
						fanTemperatureOnOffField.setCaretPosition(len);
						System.out.println("caret position: " + fanTemperatureOnOffField.getCaretPosition());
					}
				});
		...
		temperatureWarningField.addFocusListener(new FocusAdapter() {
			public void focusGained(FocusEvent e) {
				SwingUtilities.invokeLater(new Runnable() {
					public void run() {
						int len = temperatureWarningField.getDocument().getLength();
						temperatureWarningField.setCaretPosition(len);
					}
				});
			}
		...
		temperatureShutdownField.addFocusListener(new FocusAdapter() {
			public void focusGained(FocusEvent e) {
				SwingUtilities.invokeLater(new Runnable() {
					public void run() {
						int len = temperatureShutdownField.getDocument().getLength();
						temperatureShutdownField.setCaretPosition(len);
					}
				});
			}
		...
		stageTimeLimitField.addFocusListener(new FocusAdapter() {
			public void focusGained(FocusEvent e) {
				SwingUtilities.invokeLater(new Runnable() {
					public void run() {
						int len = stageTimeLimitField.getDocument().getLength();
						stageTimeLimitField.setCaretPosition(len);
					}
				});
			}
		...
		currentLimitField.addFocusListener(new FocusAdapter() {
			public void focusGained(FocusEvent e) {
				SwingUtilities.invokeLater(new Runnable() {
					public void run() {
						int len = currentLimitField.getDocument().getLength();
						currentLimitField.setCaretPosition(len);
					}
				});
			}
		...
		vacuumLimitField.addFocusListener(new FocusAdapter() {
			public void focusGained(FocusEvent e) {
				SwingUtilities.invokeLater(new Runnable() {
					public void run() {
						int len = vacuumLimitField.getDocument().getLength();
						vacuumLimitField.setCaretPosition(len);
					}
				});
			}
		...
		KpField.addFocusListener(new FocusAdapter() {
			public void focusGained(FocusEvent e) {
				SwingUtilities.invokeLater(new Runnable() {
					public void run() {
						int len = KpField.getDocument().getLength();
						KpField.setCaretPosition(len);
					}
				});
			}
		...
		KiField.addFocusListener(new FocusAdapter() {
			public void focusGained(FocusEvent e) {
				SwingUtilities.invokeLater(new Runnable() {
					public void run() {
						int len = KiField.getDocument().getLength();
						KiField.setCaretPosition(len);
					}
				});
			}
		...
		KdField.addFocusListener(new FocusAdapter() {
			public void focusGained(FocusEvent e) {
				SwingUtilities.invokeLater(new Runnable() {
					public void run() {
						int len = KdField.getDocument().getLength();
						KdField.setCaretPosition(len);
					}
				});
			}
