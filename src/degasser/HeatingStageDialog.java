...
public class HeatingStageDialog extends CenterDialogBox {
	...
	boolean showHeatingStageDialog() {
		...
		timeField = new JFormattedTextField(integerDigit);
		c.weightx = 0.5;
		c.gridx = 1;
		c.gridy = 1;
		...
		relayField = new JFormattedTextField(integerDigit);
		c.weightx = 0.5;
		c.gridx = 1;
		c.gridy = 2;
	...
	public void heatingProfileList_actionPerformed(ActionEvent event) {
		...
		timeField.setValue(new Integer(heatingProfilePanel.heatingProfile.getHeatingStage(stageSelectedIndex).getTime() ));
...
*/
	...
	public void fillInitialValues() {
		...
		if (heatingProfileList.getItemAt(0).compareTo("Add Heating Stage") != 0) {
			...
			timeField.setValue(new Integer(heatingProfilePanel.heatingProfile.getHeatingStage(initialStageIndex).getTime() ) );
