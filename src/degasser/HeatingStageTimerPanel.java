...
public class HeatingStageTimerPanel extends JPanel {
	...
	public int getTimeFromHeatingProfile(int stageNumber) {
	...
	*/
	...
	public void start() { 
		...
		// System.out.println("starting the timerBar without setting the time");
		// duration = getTimeFromHeatingProfile(heatingStage);
		logger.info("duration from start: " + duration);
		// System.out.println("duration from start: " + duration);
