...
/* Creation date Fri Sep 14 17:46:37 PDT 2018 */
package degasser;
...
public class MyReleaseInfo {
   ...
   /** buildDate (set during build process to 1536972397991L). */
   private static Date buildDate = new Date(1536972397991L);

   /**
    * Get buildDate (set during build process to Fri Sep 14 17:46:37 PDT 2018).
   ...
   /**
    * Get buildNumber (set during build process to 1976).
    * @return int buildNumber
    */
   public static final int getBuildNumber() { return 1976; }
