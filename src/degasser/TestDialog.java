...
public class TestDialog extends CenterDialogBox {
	...
	public void heatingProfileList_actionPerformed(ActionEvent event) {
		...
		// timeField.setText(Double(heatingProfilePanel.heatingProfile.getHeatingStage(stageSelectedIndex).getTime() ).toString() );
	...
	public void fillInitialValues() {
		...
		timeField.setText(new Double(heatingProfilePanel.heatingProfile.getHeatingStage(initialStageIndex).getTime() ).toString() );
